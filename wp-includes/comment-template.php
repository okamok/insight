...
//	die();
	...
	$fields   =  array(
		'author' => '<p class="comment-form-author">' . '<label for="author">' . __( '名前' ) . ( $req ? ' <span class="required">*</span>' : '' ) . '</label> ' .
	...
	$defaults = array(
		'fields'               => $fields,
		'comment_field'        => '<p class="comment-form-comment"><label for="comment">' . _x( '内容', 'noun' ) . '</label> <textarea id="comment" name="comment" cols="45" rows="8" maxlength="65525" aria-required="true" required="required"></textarea></p>',
