...
?>
		...
		<em class="comment-awaiting-moderation"><?php //_e( 'Your comment is awaiting moderation.' ) ?><?php _e( 'コメントは承認待ちです。' ) ?></em>
		<br />
		<?php endif; ?>
		...
		<<?php echo $tag; ?> id="comment-<?php comment_ID(); ?>" <?php comment_class( $this->has_children ? 'parent' : '', $comment ); ?>>
			<article id="div-comment-<?php comment_ID(); ?>" class="comment-body">
				<footer class="comment-meta">
					...
					<?php if ( '0' == $comment->comment_approved ) : ?>
					<p class="comment-awaiting-moderation"><?php //_e( 'Your comment is awaiting moderation.' ); ?><?php _e( 'コメントは承認待ちです。' ) ?></p>
					<?php endif; ?>
				</footer><!-- .comment-meta -->
